...
export const CustomerBookingsList: React.FC = () => {
  const { bookings, setActiveBookingById, setActiveView, t } = useApp();
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                ...
                <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200 text-xs space-y-1">
                  ...
                  <div className="flex justify-between items-center text-[11px] text-slate-500">
                    <span>{t('escrowStatus')}</span>
                    <span className="text-emerald-700 font-bold">{booking.paymentStatus}</span>
                  </div>
                  {isActive && (
                    <div className="flex justify-between items-center text-[11px] text-slate-700 pt-1 border-t border-slate-200">
                      <span className="font-bold">{t('securityOtp')}</span>
                      <span className="font-mono font-black text-emerald-800 bg-white px-1.5 py-0.2 rounded border border-slate-300">
                        {booking.otpCode}
                      </span>
                    </div>
                  )}
